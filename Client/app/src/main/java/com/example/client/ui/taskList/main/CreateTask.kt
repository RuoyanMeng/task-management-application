...
class CreateTask : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonDate!!.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                DatePickerDialog(this@CreateTask,
                    dateSetListener,
    ...
    private fun createNewTask() {
        ...
        // for testing
        val projectID: String? = "7Kx19DVt651Npqjnjn6R"
        ...
        Log.d("createTaskActivity", "Description is:" + description)
        Log.d("createTaskActivity", "Deadline is :" + deadTime)
        ...
        Log.d("createTaskActivity", "newProject is" + newTask)
        ...
        val request1 = Request.Builder()
            ...
            .build()
        Log.d("createTaskActivity", "Request build successfully")
        var call = okHttpClient1.newCall(request1)
        call.enqueue(object : Callback {

            override fun onFailure(call: Call, e: IOException) {
                Log.d("createTaskActivity", "Request build failed")
            }
